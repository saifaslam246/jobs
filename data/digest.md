...
### 82 | Senior Full Stack Product Engineer (TypeScript) - Maze
`arbeitnow` | United Kingdom | salary n/a

<https://www.arbeitnow.co.uk/jobs/companies/maze/senior-full-stack-product-engineer-typescript-united-kingdom-287394>
...
### 67 | Squoosh.AI | Full-Stack Engineer (full-time, REMOTE) + PhD Researcher (part-time, REMOTE US) | https://squoosh.ai We build AI systems that simulate how people explore digital exper - Squoosh.AI
`hn-hiring` | See post | salary n/a - contact: `tyler@squoosh.ai`

<https://news.ycombinator.com/item?id=49662536>

- **Why:** stack match: next.js, react, typescript; JS/TypeScript shop; full-stack role; contract/part-time signal: part time
...
### 64 | Senior Site Reliability Engineer | SRE (Remote, EU/CET) - Maze
`arbeitnow` | United Kingdom | salary n/a

<https://www.arbeitnow.co.uk/jobs/companies/maze/senior-site-reliability-engineer-sre-remote-eu-cet-united-kingdom-44874>

- **Why:** stack match: aws, docker, node.js, postgresql, react, typescript; contract/part-time signal: b2b; remote; familiar domain: insurance, saas
- **CV needs to cover:** kubernetes, terraform

### 63 | Full Stack Software Developer E-Health (f/m/d/x) - Doc Cirrus Gmbh
`arbeitnow` | Berlin | salary n/a

<https://www.arbeitnow.com/jobs/companies/doc-cirrus-gmbh/full-stack-software-developer-e-health-x-berlin-168459>

- **Why:** stack match: docker, mongodb, node.js, typescript; JS/TypeScript shop; full-stack role; contract/part-time signal: contract, part time
...
### 60 | Senior Software Engineer - Full Stack (Merchants) - Deliveroo
`jobicy` | UK | salary n/a

<https://jobicy.com/jobs/153075-senior-software-engineer-full-stack-merchants>
...
- **Why:** stack match: aws, nestjs, next.js, node.js, postgresql, react, react native; full-stack role; familiar domain: billing, booking, marketplace; posted in last 48h
- **CV needs to cover:** terraform

### 58 | Senior Frontend Engineer - Adapty.io
`arbeitnow` | London, the United Kingdom | salary n/a

<https://www.arbeitnow.co.uk/jobs/companies/adaptyio/senior-frontend-engineer-london-349982>

- **Why:** stack match: capacitor, flutter, react, react native, typescript; core-stack role title; contract/part-time signal: contract; familiar domain: insurance, saas
- **CV needs to cover:** go, figma
...
<https://news.ycombinator.com/item?id=49552714>

- **Why:** stack match: aws, mongodb, node.js, react, typescript; JS/TypeScript shop; full-stack role; remote

### 57 | Full Stack Engineer - Worldwide Placement Limited
`arbeitnow` | Berlin | salary n/a

<https://www.arbeitnow.com/jobs/companies/worldwide-placement-limited/full-stack-engineer-berlin-226964>
